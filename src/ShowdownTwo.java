class ShowdownTwo extends Showdown
{
    // This class is the exact same as the main showdown class. It is only changed to take 2 cards instead of 7.
    public double getCards(Card one, Card two) {
