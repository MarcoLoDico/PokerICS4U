class ShowdownSix extends Showdown
{
    // This class is the exact same as the main showdown class. It is only changed to take 6 cards instead of 7.
    public double getCards(Card one, Card two, Card three, Card four, Card five, Card six) {
        // Add six cards to the hand.
        hand.addCard(one);
        hand.addCard(two);
        hand.addCard(three);
        hand.addCard(four);
